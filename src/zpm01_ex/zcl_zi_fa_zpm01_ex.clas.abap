CLASS zcl_zi_fa_zpm01_ex DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_ZI_FA_ZPM01_EX IMPLEMENTATION.
...
*  REPLACE ALL OCCURRENCES OF ',' IN lv_formatted WITH '.'.
  ...
  METHOD if_rap_query_provider~select.
    ...
    DATA:
      lt_result TYPE STANDARD TABLE OF zi_fa_zpm01_ex,
      ls_result TYPE zi_fa_zpm01_ex.

    DATA:
      lt_result_ex TYPE STANDARD TABLE OF zi_fa_zpm01_ex,
      lS_result_ex TYPE zi_fa_zpm01_ex.

    DATA:
      lt_result_dk TYPE STANDARD TABLE OF zi_fa_zpm01_ex,
      ls_result_dk TYPE zi_fa_zpm01_ex.
    DATA:
      lt_result_page TYPE STANDARD TABLE OF zi_fa_zpm01_ex,
      lv_offset      TYPE i,
      lv_page_size   TYPE i,
...
WHERE
  ...
  AND (
       ...
       OR ( ( journalentry~isreversal = 'X' OR  journalentry~isreversed = 'X' ) AND @lv_isreversal = '1' ) )
 AND item_journalentry~financialaccounttype = 'K'
GROUP BY  supplier~supplieraccountgroup
ORDER BY supplier~supplieraccountgroup
INTO TABLE @DATA(lt_suppliergroup_dauky).

      SELECT
             supplier~supplieraccountgroup AS supplier_account_group,
...
*          _company~mst,
         ...
         item_journalentry~isreversed AS isreversal
          FROM i_supplier AS supplier
    ...
    LEFT JOIN i_suppliercompany  AS _suppliercompany              ON  item_journalentry~offsettingaccount = _suppliercompany~supplier
 ...
 DELETE lt_supplier_dauky WHERE dauky_vnd = 0 AND dauky_nt_vnd = 0 AND dauky = 0.
      LOOP AT lt_supplier_dauky ASSIGNING FIELD-SYMBOL(<fs_dauky>).
        ...
        IF sy-subrc <> 0.
          ...
          ls_result-supplier_account_group = <fs_dauky>-supplier_account_group.
      ...
      SORT lt_result BY supplier_account_group supplier postingdate accountingdocument.
      lv_stt = lv_stt + 1.


      LOOP AT lt_result ASSIGNING FIELD-SYMBOL(<lfs_zpm01>) .
        IF lv_layout = '01'.
          AT NEW supplier_account_group.

            lv_stt = lv_stt + 1.
            ls_result_ex-stt = lv_stt.
            ls_result_ex-supplier = <lfs_zpm01>-supplier.
            ls_result_ex-des = <lfs_zpm01>-supplieraccountgroup.
            ls_result_ex-stt = lv_stt.
            ...
            ls_result_ex-stt = lv_stt.
            ls_result_ex-supplier = <lfs_zpm01>-supplier.
            ls_result_ex-des = 'Số dư đầu kỳ' && ' ' && <lfs_zpm01>-supplieraccountgroup.
            READ TABLE lt_suppliergroup_dauky ASSIGNING FIELD-SYMBOL(<lfs_sag_dauky>) WITH KEY  supplieraccountgroup = <lfs_zpm01>-supplier_account_group BINARY SEARCH.
            IF sy-subrc = 0.

              IF <fs_dauky>-dauky_vnd >= 0.
                ls_result_ex-zno_vnd =  abs( <lfs_sag_dauky>-dauky_vnd ).
              ELSE.
                ls_result_ex-zco_vnd =  abs( <lfs_sag_dauky>-dauky_vnd ).
              ENDIF.
              IF <lfs_sag_dauky>-dauky_nt_vnd >= 0.
                ls_result_ex-zno_nt = abs( <lfs_sag_dauky>-dauky_nt ).
              ELSE.
                ls_result_ex-zco_nt = abs( <lfs_sag_dauky>-dauky_nt ).
              ENDIF.

              IF <lfs_sag_dauky>-dauky >= 0.
                ls_result_ex-zno =  <lfs_sag_dauky>-dauky.
              ELSE.
                ls_result_ex-zco = abs( <lfs_sag_dauky>-dauky ).
              ENDIF.

              ls_post-sum_ct9   = ls_post-sum_ct9 + <lfs_sag_dauky>-dauky_vnd.
              ls_post-sum_ct11  = ls_post-sum_ct11 + <lfs_sag_dauky>-dauky_nt.
              ls_post-sum_nosddk  = ls_post-sum_nosddk + <lfs_sag_dauky>-dauky.
            ENDIF.
        ...
        AT NEW supplier.
          ...
          ls_result_ex-stt = lv_stt.
          ls_result_ex-supplier = <lfs_zpm01>-supplier.
          ls_result_ex-des = <lfs_zpm01>-ncc.
          APPEND ls_result_ex TO lt_result_ex.
          CLEAR ls_result_ex.
          ...
          READ TABLE lt_group_dauky ASSIGNING FIELD-SYMBOL(<lfs_dauky>) WITH KEY  companycode = <lfs_zpm01>-companycode supplier = <lfs_zpm01>-supplier BINARY SEARCH.
          IF sy-subrc = 0.
          ...
          IF <lfs_zpm01>-accountingdocument IS INITIAL.

            ls_result_ex-zno_vnd =  abs( <lfs_zpm01>-zno_vnd ).
            ls_result_ex-zco_vnd = abs( <lfs_zpm01>-zco_vnd ).
            ls_result_ex-zno_nt = abs( <lfs_zpm01>-zno_nt ).
            ls_result_ex-zco_nt = abs( <lfs_zpm01>-zco_nt ).
            ls_result_ex-zno = abs( <lfs_zpm01>-zno ).
            ls_result_ex-zco = abs( <lfs_zpm01>-zco ).

            ls_supplier_header-ct9_nodk_vnd = <lfs_zpm01>-zno_vnd.
            ls_supplier_header-ct10_codk_vnd = abs( <lfs_zpm01>-zco_vnd ).
            ls_supplier_header-ct11_nodk = <lfs_zpm01>-zno_nt.
            ls_supplier_header-ct12_codk = abs( <lfs_zpm01>-zco_nt ).
            ls_supplier_header-ct44_nodk = <lfs_zpm01>-zno .
            ls_supplier_header-ct45_codk =  abs( <lfs_zpm01>-zco ) .
        ...
        <lfs_zpm01>-ct46_curr  = <lfs_zpm01>-ct46_curr."ct30_curr + <lfs_zpm01>-ct32_curr * (  <lfs_zpm01>-taxexchangerate * 10 ) .
        <lfs_zpm01>-ct47_curr  = <lfs_zpm01>-ct47_curr."ct31_curr + <lfs_zpm01>-ct33_curr * (  <lfs_zpm01>-taxexchangerate * 10 ) .

          <lfs_zpm01>-zno_vnd = <lfs_zpm01>-ct30_curr .
          <lfs_zpm01>-zco_vnd = <lfs_zpm01>-ct31_curr * -1.
          <lfs_zpm01>-zno_nt = <lfs_zpm01>-ct32_curr .
          <lfs_zpm01>-zco_nt = <lfs_zpm01>-ct33_curr * -1.
          <lfs_zpm01>-zno = <lfs_zpm01>-ct46_curr.
          <lfs_zpm01>-zco = <lfs_zpm01>-ct47_curr * -1.

        CONDENSE <lfs_zpm01>-zco_vnd NO-GAPS.
        CONDENSE <lfs_zpm01>-zno_vnd NO-GAPS.
        CONDENSE <lfs_zpm01>-zco_nt NO-GAPS.
        CONDENSE <lfs_zpm01>-zno_nt NO-GAPS.
        CONDENSE <lfs_zpm01>-zco NO-GAPS.
        CONDENSE <lfs_zpm01>-zno NO-GAPS.
        ...
        ls_result_ex-zno = format_amount_string( i_currency = CONV string( 'VND' ) i_input = CONV string( ls_result_ex-zno ) ).
              ...
              IF sy-subrc = 0.
                    <lfs_zpm01>-accountingdocumentheadertext = <lfs_text>-PurchaseOrderItemText.
              endif.
          endif.

* Start - Get data lt_journal_entrys
        MOVE-CORRESPONDING <lfs_zpm01> TO ls_result_ex.
        ...
        ls_supplier-ct45_cpsc       = ls_supplier-ct45_cpsc +  <lfs_zpm01>-ct47_curr.

        READ TABLE lt_outbound ASSIGNING FIELD-SYMBOL(<lfs_outbound>) WITH KEY  billingdocument = <lfs_zpm01>-billingdoc BINARY SEARCH.
        IF sy-subrc = 0.
          ls_result_ex-z_invoiceno = <lfs_outbound>-yy1_invoiceno_dlh.
        ENDIF.
        ls_result_ex-stt = lv_stt.
        IF <lfs_zpm01>-accountingdocument IS NOT INITIAL.

          <lfs_zpm01>-zco_vnd = ls_result_ex-zco_vnd * -1.
          <lfs_zpm01>-zco_nt = <lfs_zpm01>-zco_nt * -1.
          <lfs_zpm01>-zco = <lfs_zpm01>-zco * -1.
...
* Start - Get data lt_suppliers
        AT END OF supplier.
          IF lv_layout = '02'.
            ...
            ls_result_ex-zco_vnd =  abs( ls_supplier-ct14_cpsc_vnd ).
            ls_result_ex-zno_nt = ls_supplier-ct15_cpsn.
            ls_result_ex-zco_nt =  abs( ls_supplier-ct16_cpsc ).
            ls_result_ex-zno = ls_supplier-ct44_cpsn.
            ls_result_ex-zco =  abs( ls_supplier-ct45_cpsc ).

            ls_post-sum_cpsn_vnd = ls_post-sum_cpsn_vnd + ls_supplier-ct13_cpsn_vnd.
            ls_post-sum_cpsc_vnd = ls_post-sum_cpsc_vnd + ls_supplier-ct14_cpsc_vnd.
            ls_post-sum_cpsn = ls_post-sum_cpsn + ls_supplier-ct15_cpsn.
            ls_post-sum_cpsc = ls_post-sum_cpsc + ls_supplier-ct16_cpsc.
            ls_post-sum_cpsn_lk = ls_post-sum_cpsn_lk + ls_supplier-ct44_cpsn.
            ls_post-sum_cpsc_lk = ls_post-sum_cpsc_lk + ls_supplier-ct45_cpsc.
...
ELSE.
  ls_result_ex-zco_vnd =
       abs( abs( ls_supplier_header-ct9_nodk_vnd )
   - abs( ls_supplier_header-ct10_codk_vnd )
   + abs( ls_supplier-ct13_cpsn_vnd )
   - abs( ls_supplier-ct14_cpsc_vnd ) ).
ENDIF.
...
ELSE.
  ls_result_ex-zco_nt =
      abs( abs( ls_supplier_header-ct11_nodk )
   - abs( ls_supplier_header-ct12_codk )
   + abs( ls_supplier-ct15_cpsn )
   - abs( ls_supplier-ct16_cpsc ) ).
ENDIF.
...
ELSE.
  ls_result_ex-zco =
      abs( abs( ls_supplier_header-ct44_nodk )
   - abs( ls_supplier_header-ct45_codk )
   + abs( ls_supplier-ct44_cpsn )
   - abs( ls_supplier-ct45_cpsc ) ).
ENDIF.
...
ls_post-sum_nosddk =
  ...
  - abs( ls_supplier-ct45_cpsc ).
          ...
          ELSE.
            ...
            ls_suppliergroup-sum_cpsc_vnd = ls_suppliergroup-sum_cpsc_vnd + ls_supplier-ct14_cpsc_vnd.
            ls_suppliergroup-sum_cpsn = ls_suppliergroup-sum_cpsn + ls_supplier-ct15_cpsn.
            ls_suppliergroup-sum_cpsc = ls_suppliergroup-sum_cpsc + ls_supplier-ct16_cpsc.
            ls_suppliergroup-sum_cpsn_lk = ls_suppliergroup-sum_cpsn_lk + ls_supplier-ct44_cpsn.
            ls_suppliergroup-sum_cpsc_lk = ls_suppliergroup-sum_cpsc_lk + ls_supplier-ct45_cpsc.
            ls_result_ex-des = 'Cộng phát sinh'.
...
ENDIF.
            ...
            ls_suppliergroup-sum_nosddk = ls_post-sum_nosddk + ls_supplier_header-ct44_nodk - ls_supplier_header-ct45_codk + ls_supplier-ct44_cpsn - ls_supplier-ct45_cpsc.


ls_suppliergroup-sum_sdnck_vnd =
      ls_suppliergroup-sum_sdnck_vnd
    + abs( ls_supplier_header-ct9_nodk_vnd )
    - abs( ls_supplier_header-ct10_codk_vnd )
    + abs( ls_supplier-ct13_cpsn_vnd )
...
ls_suppliergroup-sum_sdnck_lk =
    ...
    - abs( ls_supplier-ct45_cpsc ).
        ...
        IF lv_layout = '01'.
          AT END OF supplier_account_group.
            lv_stt = lv_stt + 1.
            ls_result_ex-stt = lv_stt.

            ls_result_ex-zno_vnd = ls_suppliergroup-sum_cpsn_vnd.
            ls_result_ex-zco_vnd = abs( ls_suppliergroup-sum_cpsc_vnd ).
            ls_result_ex-zno_nt = ls_suppliergroup-sum_cpsn.
            ls_result_ex-zco_nt = abs( ls_suppliergroup-sum_cpsc ).
            ls_result_ex-zno = ls_suppliergroup-sum_cpsn_lk.
            ls_result_ex-zco = abs( ls_suppliergroup-sum_cpsc_lk ).
            ...
            ls_result_ex-des = 'Cộng phát sinh' && ' ' && <lfs_zpm01>-supplieraccountgroup.
            ...
            ls_result_ex-des = 'Số dư cuối kỳ' && ' ' &&  <lfs_zpm01>-supplieraccountgroup.
            APPEND ls_result_ex TO lt_result_ex.
            CLEAR ls_result_ex.
      ...
      ELSE.
        ls_result_ex-zco = abs( ls_post-sum_nosddk ).
      ENDIF.
      ...
      ls_result_ex-zco_vnd = abs( ls_post-sum_cpsc_vnd ).
      ls_result_ex-zno_nt  = ls_post-sum_cpsn.
      ls_result_ex-zco_nt  = abs( ls_post-sum_cpsc ).
      ls_result_ex-zno  = ls_post-sum_cpsn_lk.
      ls_result_ex-zco  = abs( ls_post-sum_cpsc_lk ).
      ...
      ELSE.
        ls_result_ex-zco_vnd = abs( ls_post-sum_sdnck_vnd ).
      ENDIF.
      IF ls_post-sum_sdnck >= 0.
        ls_result_ex-zno_nt  = ls_post-sum_sdnck.
      ELSE.
        ls_result_ex-zco_nt  = abs( ls_post-sum_sdnck ).
      ENDIF.
      IF ls_post-sum_sdnck_lk >= 0.
        ls_result_ex-zno  = ls_post-sum_sdnck_lk.
      ELSE.
        ls_result_ex-zco  = abs( ls_post-sum_sdnck_lk ).
      ENDIF.
