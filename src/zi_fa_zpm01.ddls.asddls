@EndUserText.label: 'View Entity for ZPM01– Sổ chi tiết công nợ phải trả NCC, NV'
@ObjectModel.query.implementedBy: 'ABAP:ZCL_ZI_FA_ZPM01_N'
@Metadata.allowExtensions: true

define root custom entity ZI_FA_ZPM01
{
  key Supplier                       : lifnr;
