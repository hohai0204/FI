CLASS zcl_virtual_zrm03_v DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  PUBLIC SECTION.
...
CLASS ZCL_VIRTUAL_ZRM03_V IMPLEMENTATION.


  METHOD if_sadl_exit_calc_element_read~calculate.
    DATA: lt_data_i TYPE STANDARD TABLE OF zc_fa_zrm03 WITH DEFAULT KEY. "zsd_c_zsd03_items
