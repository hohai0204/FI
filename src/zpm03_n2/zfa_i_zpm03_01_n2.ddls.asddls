...
define view entity ZFA_I_ZPM03_01_N2
...

{
  ...
  case when fi_item.YY1_NgayXuatHoaDon_COB is not initial then fi_item.YY1_NgayXuatHoaDon_COB
       else Fi_head.PostingDate end                                                                                                                   as PostingDate,
  //  Fi_head.PostingDate,
