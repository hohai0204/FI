CLASS zcl_fa_zpm03_ex_n2 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_FA_ZPM03_EX_N2 IMPLEMENTATION.


  METHOD if_rap_query_provider~select.
    "khai báo ===========================================================
    DATA: lt_results_head TYPE STANDARD TABLE OF  zfa_i_zpm03_ex_n2,
          lt_results      TYPE STANDARD TABLE OF  zfa_i_zpm03_ex_n2,
          lt_result_page  TYPE STANDARD TABLE OF zfa_i_zpm03_ex_n2.
    TRY.
   ...
   INTO CORRESPONDING FIELDS OF  TABLE @lt_results.
    ...
    IF lt_results IS INITIAL.
      ...
      SELECT  zc_fa_zpm03_nw_n2~*, 'B' AS zsort FROM zc_fa_zpm03_nw_n2
      ...
      INTO CORRESPONDING FIELDS OF TABLE @lt_results.
*      loop at lt_results ASSIGNING FIELD-SYMBOL(<ls_result_1>).
*
*      select single
*      AssignmentReference
*      from ZI_VIEW_MST
*      where AccountingDocument = @<ls_result_1>-AccountingDocument
*      and CompanyCode = @<ls_result_1>-CompanyCode
*      into @<ls_result_1>-MST_Supplier.
*
*            select single
*      YY1_TDV_JEI
*      from zi_view_tennguoiban
*      where AccountingDocument = @<ls_result_1>-AccountingDocument
*      and CompanyCode = @<ls_result_1>-CompanyCode
*      into @<ls_result_1>-SupplierName.
*
*      endloop.

*      delete ADJACENT DUPLICATES FROM lt_results.
      SORT lt_results BY  tax_group postingdate accountingdocument taxcode.
      DATA: ls_group  TYPE  zfa_i_zpm03_ex_n2,
            ls_result TYPE  zfa_i_zpm03_ex_n2,
            ls_last   TYPE  zfa_i_zpm03_ex_n2,
            lt_group  TYPE STANDARD TABLE OF  zfa_i_zpm03_ex_n2.
      DATA: lv_stt TYPE i.
