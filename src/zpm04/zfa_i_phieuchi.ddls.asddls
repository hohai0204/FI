...
@EndUserText.label: 'Entity Phiếu Chi'
...
define view entity ZFA_I_PHIEUCHI
                                                            ...
                                                            and pdf.report_id                     = 'ZFI_PM04'
{
  key concat( concat(I_JournalEntry.CompanyCode,I_JournalEntry .FiscalYear ), I_JournalEntry .AccountingDocument ) as Object,
      ...
      when Customer.IsOneTimeAccount is not initial then
          concat_with_space( OTA_SUP.StreetAddressName, OTA_SUP.CityName, 1)
           else
      Customer.Adress12345
      ...
      @Semantics.amount.currencyCode: 'curency'
      acc_111_H_a.amount * (- 1 )                                                                                  as Amountcredit,
      acc_111_H.TransactionCurrency                                                                                as curency,
      ...
      @Semantics.amount.currencyCode: 'curency_vnd'
      acc_111_H_a.amount_VND  * (- 1 )                                                                             as Amountcredit_VND,
      acc_111_H.CompanyCodeCurrency                                                                                as curency_vnd,
      pdf.attachment,
      pdf.filename,
      pdf.mimetype
}
...
where
  I_JournalEntry.AccountingDocumentType = 'CP'
