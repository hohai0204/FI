CLASS zcl_zrm02_lines_impl DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: tt_data_output TYPE STANDARD TABLE OF zfa_i_zrm02_lines.
  PROTECTED SECTION.
  PRIVATE SECTION.
...
CLASS ZCL_ZRM02_LINES_IMPL IMPLEMENTATION.
  ...
  METHOD get_data.
    ...
    SELECT *
    FROM ztb_exc_zrm02 AS exc_zrm02
    WHERE report_id = 'ZRM02'
