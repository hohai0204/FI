@EndUserText.label: 'Root Custom Entity ZAA01 (Excel)'
@ObjectModel.query.implementedBy: 'ABAP:ZCL_FA_ZAA01_EX'
@Metadata.allowExtensions: true
define custom entity ZFA_R_ZAA01_EX

{
  ...
  key stt                         : abap.int4;
      ...
      tang_nguyen_gia_trong_ki    : abap.dec(25,2);
      @Semantics.amount.currencyCode: 'currency'
      tang_khau_hao_trong_ki      : abap.dec(25,2);
      @Semantics.amount.currencyCode: 'currency'
      giam_nguyen_gia_trong_ky    : abap.dec(25,2);
      @Semantics.amount.currencyCode: 'currency'
      giam_khau_hao_trong_ky      : abap.dec(25,2);
      @Semantics.amount.currencyCode: 'currency'
      nguyen_gia_dau_ky           : abap.dec(25,2);
      @Semantics.amount.currencyCode: 'currency'
      khau_hao_luy_ke_dau_ky      : abap.dec(25,2);
      @Semantics.amount.currencyCode: 'currency'
      gia_tri_con_lai_dau_ky      : abap.dec(25,2);
      
      tk_nguyen_gia               : abap.char(20);
      tk_chi_phi                  : abap.char(20);
      tk_khau_hao                 : abap.char(20);
      @Semantics.amount.currencyCode: 'currency'
      nguyen_gia_cuoi_ky          : abap.dec(25,2);
      @Semantics.amount.currencyCode: 'currency'
      khau_hao_luy_ke_cuoi_ky     : abap.dec(25,2);
      @Semantics.amount.currencyCode: 'currency'
      gia_tri_con_lai_cuoi_ky     : abap.dec(25,2);
